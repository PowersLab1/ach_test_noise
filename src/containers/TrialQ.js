...
class TrialQ extends Component {
  constructor(props) {
    ...
    this.q1 = new questlib.Quest(tGuess1, tGuessSd, pThreshold, beta, delta, gamma, grain, range); //want to add whitenoisevolume to have it at the end but it doesn't save
